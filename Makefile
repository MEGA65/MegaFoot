...
getdat:
	c1541 -attach "C:\Users\gurcei\AppData\Roaming\xemu-lgb\mega65\hdos\11.D81" -read layers.bin -read foot foot.prg -read repaired.bin -read "level1-bg.bin" -read "level1-bg.dat" -read "player.bin" -read "player.dat" -read "duck.bin" -read "duck.dat"
