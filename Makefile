...
pushdat: level1-bg.bin player.bin player2.bin player3.bin duck.bin
	...
	c1541 -attach "C:\Users\gurcei\AppData\Roaming\xemu-lgb\mega65\hdos\11.D81" -delete player2.bin -write player3.bin
	c1541 -attach "C:\Users\gurcei\AppData\Roaming\xemu-lgb\mega65\hdos\11.D81" -delete player2.dat -write player3.dat
...
getdat:
	c1541 -attach "C:\Users\gurcei\AppData\Roaming\xemu-lgb\mega65\hdos\11.D81" -read foot foot.prg -read "level1-bg.bin" -read "level1-bg.dat" -read "player.bin" -read "player.dat" -read "player2.bin" -read "player2.dat" -read "player3.bin" -read "player3.dat" -read "duck.bin" -read "duck.dat"
